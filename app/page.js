          ...
          <div className="relative flex flex-row justify-between py-4 align-center md:py-6">
            <div className="flex items-center flex-1">
              ...
              <nav className="ml-6 space-x-2 lg:block">
                    <button onClick={()=>handlePageChange('home')}   className='relative w-1/2 bg-white shadow-sm border-2 border-purple-800 text-purple-800 rounded-md m-1 py-2 text-s font-medium whitespace-nowrap hover:bg-purple-800 hover:text-white ease-linear duration-200  sm:w-auto sm:px-8'>Home</button>
        ...
        <>
           {pageName=='home' &&
            ...
            <div className='flex flex-wrap justify-center gap-6 ml-20 mr-20 mt-5 mb-5 bg-white rounded p-10'>
                <div className='flex flex-col  flex-1 text-gray-800'>Signed in as {user.displayName}<br/>{user.email}<br/>
            ...
            { pageName=='charts' && 
                    <><div className='sm:flex sm:flex-col sm:align-center'>
                    <div className='relative flex flex-row ml-24'>
                    <button onClick={()=>handlePageChange('home')}   className='text-purple-800 underline '>Home</button>
